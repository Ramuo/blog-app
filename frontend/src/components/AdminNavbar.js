...
const navigation = [
  ...
  { name: "Créer", href: "/create-post", current: false },
  { name: "Publications", href: "/postlist", current: false },
  { name: "Auteurs", href: "/users", current: false },
  { name: "+Categorie", href: "/category", current: false },
  { name: "Liste Categorie", href: "/categoryList", current: false },
];
...
const AdminNavbar = ({isLogin}) => {
  ...
  const userNavigation = [
    { name: "Votre Profile", href: `/profile/${isLogin?._id}` },
    { name: "Changer mot de passe", href: "/updatepassword" },
            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="flex-shrink-0 flex items-center">
                  {/* Logo */}
                  <FaBookOpen className="h-10 w-10 text-yellow-200" />
                </div>
